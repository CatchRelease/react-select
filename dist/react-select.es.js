...
var MultiValueLabel = function (_Component) {
  inherits(MultiValueLabel, _Component);

  function MultiValueLabel() {
    classCallCheck(this, MultiValueLabel);
    return possibleConstructorReturn(this, (MultiValueLabel.__proto__ || Object.getPrototypeOf(MultiValueLabel)).apply(this, arguments));
  }

  createClass(MultiValueLabel, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          children = _props.children,
...
var MultiValueRemove = function (_Component2) {
  inherits(MultiValueRemove, _Component2);
  ...
  createClass(MultiValueRemove, [{
    ...
    value: function render() {
      var _props2 = this.props,
          children = _props2.children,
          props = objectWithoutProperties(_props2, ['children']);
...
var MultiValue = function (_Component3) {
  inherits(MultiValue, _Component3);
  ...
  createClass(MultiValue, [{
    ...
    value: function render() {
      var _props3 = this.props,
          ...
          innerProps = _props3.innerProps,
          isDisabled = _props3.isDisabled,
          labelProps = _props3.labelProps,
          removeProps = _props3.removeProps;
      ...
      return React.createElement(
        ...
        React.createElement(
          Label,
          _extends({ className: cn.label, data: data }, labelProps),
          children
        ),
        React.createElement(Remove, _extends({ className: cn.remove, data: data }, removeProps))
      );
    }
  }]);
  return MultiValue;
...
var Select = function (_Component) {
  ...
  createClass(Select, [{
    ...
    value: function constructAriaLiveMessage() {
      ...
      var focusedValueMsg = focusedValue ? valueFocusAriaMessage({ focusedValue: focusedValue, getOptionLabel: this.getOptionLabel, selectValue: selectValue }) : '';
      // An aria live message representing the currently focused option in the select.
      var focusedOptionMsg = focusedOption && menuIsOpen ? optionFocusAriaMessage({ focusedOption: focusedOption, getOptionLabel: this.getOptionLabel, options: options }) : '';
      // An aria live message representing the set of focusable results and current searchterm/inputvalue.
      var resultsMsg = resultsAriaMessage({ inputValue: inputValue, screenReaderMessage: screenReaderStatus({ count: this.countOptions() }) });
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.announceAriaLiveContext = function (_ref3) {
    ...
    _this7.setState({
      ariaLiveContext: instructionsAriaMessage(event, _extends({}, context, { label: _this7.props['aria-label'] }))
    });
  };
...
var Input$2 = AnimatedComponents.Input;
...
export { Select as SelectBase, Async, AsyncCreatable, Creatable, createFilter, makeAnimated, components, mergeStyles };
