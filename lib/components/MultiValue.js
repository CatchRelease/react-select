...
var MultiValueLabel = exports.MultiValueLabel = function (_Component) {
  _inherits(MultiValueLabel, _Component);

  function MultiValueLabel() {
    _classCallCheck(this, MultiValueLabel);

    return _possibleConstructorReturn(this, (MultiValueLabel.__proto__ || Object.getPrototypeOf(MultiValueLabel)).apply(this, arguments));
  }

  _createClass(MultiValueLabel, [{
    key: 'render',
...
var MultiValueRemove = exports.MultiValueRemove = function (_Component2) {
  _inherits(MultiValueRemove, _Component2);
...
var MultiValue = function (_Component3) {
  _inherits(MultiValue, _Component3);
  ...
  _createClass(MultiValue, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(Remove, _extends({ className: cn.remove, data: data }, removeProps))
      );
    }
  }]);
